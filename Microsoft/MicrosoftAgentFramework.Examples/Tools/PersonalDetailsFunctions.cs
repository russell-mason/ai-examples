...
public static class PersonalDetailsFunctions
{
    ...
    public static IList<AITool> AsAITools() => new List<AITool>
                                               {
                                                   AIFunctionFactory.Create(GetPeople),
                                                   AIFunctionFactory.Create(GetAreaCode)
                                               };
}
