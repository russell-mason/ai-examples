...
// Taken directly from MS examples (naming/formatting left as is!)
// https://github.com/microsoft/semantic-kernel/blob/13e3a223af40bafeae4cc95efebcee23592b2efc/dotnet/samples/GettingStarted/Step8_Pipelining.cs#L105-L132
...
public static class KernelFunctionCombinators
{
    ...
    /// <param name="cancellationToken">The cancellation token to monitor for a cancellation request.</param>
    public static Task<FunctionResult> InvokePipelineAsync(
        IEnumerable<(KernelFunction Function, string OutputVariable)> functions, Kernel kernel, KernelArguments arguments,
