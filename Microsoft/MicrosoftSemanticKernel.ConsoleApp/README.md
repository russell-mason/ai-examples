...
**N.B.** Ensure you set **MicrosoftSemanticKernel.ConsoleApp** as the startup project.

- This is for experimental purposes only, used to aid in the learning and exploration of AI through Semantic Kernel
...
See the **README.md** file in **MicrosoftSemanticKernel.Examples** for more details.
